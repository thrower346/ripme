...
public class CreepShotsRipper extends AbstractHTMLRipper {

    public CreepShotsRipper(URL url) throws IOException {
        super(url);
    }
    ...
    public String getDomain() {
        return "creepshots.org";
    }

    @Override
    public String getGID(URL url) throws MalformedURLException {
        Pattern p = Pattern.compile("^https?://[wm.]*creepshots\\.org/wp-content/uploads/([a-zA-Z0-9]+).*$");
